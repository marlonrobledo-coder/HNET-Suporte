...
export const FLOWCHART_DATA: { [key: string]: FlowchartNode } = {
  ...
  'search_fallback': {
    ...
    type: NodeType.SOLUTION,
    title: 'Busca por IA',
    text: 'A busca por IA não encontrou um passo específico. Por favor, tente refinar sua busca ou siga o fluxo padrão começando pela "Identificação do Problema".',
    icon: ExclamationTriangleIcon,
  },
};
